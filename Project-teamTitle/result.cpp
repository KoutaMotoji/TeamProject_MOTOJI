...
//頂点バッファをロックして、頂点情報へのポインタを取得
	g_pVtxBuffResult->Lock(0, 0, (void**)&pVtx, 0);
	//テクスチャ座標の設定
	pVtx[0].tex = D3DXVECTOR2(0.0f + g_PAPAPAPAP, 0.0f);
	pVtx[1].tex = D3DXVECTOR2(1.0f + g_PAPAPAPAP, 0.0f);
	pVtx[2].tex = D3DXVECTOR2(0.0f + g_PAPAPAPAP, 1.0f);
	pVtx[3].tex = D3DXVECTOR2(1.0f + g_PAPAPAPAP, 1.0f);
